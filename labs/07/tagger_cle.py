...
class Model(npfl138.TrainableModule):
    ...
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        rnn_input_size = args.we_dim + 2 * args.cle_dim
        if (args.rnn=="LSTM"):
            self._word_rnn = torch.nn.LSTM(input_size=rnn_input_size, hidden_size=args.rnn_dim, bidirectional=True)
        elif (args.rnn=="GRU"):
            self._word_rnn = torch.nn.GRU(input_size=rnn_input_size, hidden_size=args.rnn_dim, bidirectional=True)
